...
const Footer = () => {
  return (
    <footer className="text-white montserrat-bold bg-zinc-950/60 flex justify-around items-center  absolute bottom-0 right-0 left-0 py-12 px-6">
      <div className="w-1/5 justify-center text-center flex flex-col text-[2.5vw] gap-2  leading-5 tracking-wider  border-r-2 border-gray-400/45 pr-10">
          27K +
        <span className=" text-center text-[0.9vw] tracking-wider text-gray-300">
          ARTISTS
        </span>
      </div>
      <div className="w-1/5 justify-center text-center flex flex-col text-[2.5vw] gap-2  leading-5 tracking-wider border-r-2 border-gray-400/45 pr-10">
        876K+
        <span className=" text-[0.9vw] tracking-wider text-gray-300">
          ARTWORK
        </span>
      </div>
      <div className="w-1/5 justify-center text-center flex flex-col text-[2.5vw] gap-2  leading-5 tracking-wider border-r-2 border-gray-400/45 pr-10">
